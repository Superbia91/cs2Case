...
public class SpectrumTwo {
    public static final List<DropEntry> DROPS_SPECTRUM_TWO = List.of(
            ...
            new DropEntry(ModItems.CLASSIC_KNIFE,Rarity.KNIFE,5),
            new DropEntry(ModItems.BAYONET,Rarity.KNIFE,4),
            new DropEntry(ModItems.KUKRI_KNIFE,Rarity.KNIFE,7));
