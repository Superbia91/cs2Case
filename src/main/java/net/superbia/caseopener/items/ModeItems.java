...
public class ModeItems {
    ...
    private static Item.Properties knifeProps() {
        return new Item.Properties().stacksTo(1).durability(2500);
    }
    ...
    public static final RegistryObject<Item> KERAMBIT =
            ITEMS.register("kerambit", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));

    public static final RegistryObject<Item> BAYONET =
            ITEMS.register("bayonet", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));

    public static final RegistryObject<Item> FLIP_KNIFE =
            ITEMS.register("flipknife", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));
    ...
    public static final RegistryObject<Item> HUNTSMAN_KNIFE =
            ITEMS.register("huntsmanknife", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));

    public static final RegistryObject<Item> FALCHION_KNIFE =
            ITEMS.register("falchionknife", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));

    public static final RegistryObject<Item> BOWIE_KNIFE =
            ITEMS.register("bowieknife", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));

    public static final RegistryObject<Item> BUTTERFLY_KNIFE =
            ITEMS.register("butterflyknife", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));

    public static final RegistryObject<Item> SHADOW_DAGGERS =
            ITEMS.register("shadowdaggers", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));

    public static final RegistryObject<Item> NAVAJA_KNIFE =
            ITEMS.register("navajaknife", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));

    public static final RegistryObject<Item> STILETTO_KNIFE =
            ITEMS.register("stilettoknife", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));

    public static final RegistryObject<Item> TALON_KNIFE =
            ITEMS.register("talonknife", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));

    public static final RegistryObject<Item> URSUS_KNIFE =
            ITEMS.register("ursusknife", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));

    public static final RegistryObject<Item> NOMAD_KNIFE =
            ITEMS.register("nomadknife", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));

    public static final RegistryObject<Item> SKELETON_KNIFE =
            ITEMS.register("skeletonknife", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));

    public static final RegistryObject<Item> PARACORD_KNIFE =
            ITEMS.register("paracordknife", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));

    public static final RegistryObject<Item> SURVIVAL_KNIFE =
            ITEMS.register("survivalknife", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));

    public static final RegistryObject<Item> CLASSIC_KNIFE =
            ITEMS.register("classicknife", () -> new KnifeItem(KNIFE_TIER, KNIFE_DAMAGE_BONUS, KNIFE_ATTACK_SPEED, knifeProps()));
